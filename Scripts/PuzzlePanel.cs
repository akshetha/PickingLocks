...
public class PuzzlePanel : MonoBehaviour
{
    ...
    public SpriteRenderer block1, block2, block3;

    [Header("Right static targets")]
    public SpriteRenderer target1, target2, target3;

    private Transform[] slots;
    private SpriteRenderer[] blocks;
    private Color[] trueColors = new Color[3];

    void Awake()
    {
        slots  = new Transform[]      { slot1, slot2, slot3 };
        blocks = new SpriteRenderer[] { block1, block2, block3 };
    }
    ...
    {
        return slots[1].position; // middle of 3
    }
