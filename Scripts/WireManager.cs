...
public class WireManager : MonoBehaviour
{
    ...
    public string nextSceneName = "lev2";
    ...
    void Start()
    {
        ...
        {
            new Color[] { colorGreen,  colorOrange, colorPurple },
            new Color[] { colorPurple, colorGreen,  colorOrange },
            new Color[] { colorOrange, colorPurple, colorGreen  },
        };
    ...
    void OnNumberPressed(int slotNumber)
    {
        ...
        PuzzlePanel panel = panels[currentPanel];
    ...
    IEnumerator SwapAndFollowPlayer(PuzzlePanel panel, int from, int to)
    {
        locked = true;
    ...
    void MovePlayerToBlock(PuzzlePanel panel, int idx)
    {
        Vector3 blockPos = panel.GetSlotPosition(idx);
        character.position = blockPos + new Vector3(-2.8f, 0, 0);
    }

    void MovePlayerToMiddleBlock(PuzzlePanel panel)
    {
